...
type SerializedAXNode = {
  ...
  name?: string; // The accessible , username of the node
  ...
  haspopup?: string; // The type of popup tri, userggered by the node
...
function URLInputForm({ setA11yTree, user }: URLInputFormProps) {
